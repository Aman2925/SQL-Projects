...
-- **Database Creation**: Created a database named `spotify`
-- **Table Creation**: Created a table to store track, artist, album, audio features, and engagement metrics with appropriate data types to support analytical queries.
